...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/ทีเด็ดบาสวันละตัว">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/ทีเด็ดบาสวันละตัว" rel="canonical">
@endsection
                    ...
                    <table class="table table-condensed text-white">
                        <thead class="card-prediction">
                            <tr>
                                ...
                                <th class="text-center">ทีเด็ดบาสวันละตัวที่เลือก</th>
                                <th>ทีเด็ดบาส ล้มโต๊ะ</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (count($tded_datas) > 0)
                                @foreach($tded_datas as $tded)
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex df-col alit-center">
                                                <span>{{ $tded['match_time'] }}</span>
                                                <span>{{ $tded['match_date'] }}</span>
                                            </div>
                                        </td>
