...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/ทีเด็ดบาส">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/ทีเด็ดบาส" rel="canonical">
@endsection
                ...
                <div class="table-responsive">
                    <table class="table table-condensed text-white">
                        <thead class="card-prediction">
                            <tr>
                                <th>เวลาแข่ง</th>
                                <th class="text-center">ทีเด็ดบาสวันนี้</th>
