...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/ทีเด็ดบอลเต็ง">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/ทีเด็ดบอลเต็ง" rel="canonical">
@endsection
                    ...
                    <table class="table table-condensed text-white">
                        <thead class="card-prediction">
                            <tr>
                                ...
                                <th class="text-center">ทีเด็ดบอลเต็งที่เลือก</th>
