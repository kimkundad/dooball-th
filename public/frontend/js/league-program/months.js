    ...
    $.ajax({
        ...
        success: function (fixtures) {
            if (fixtures.length > 0) {
                groupByYear(fixtures);
            } else {
                console.log('--- Not found fixtures in league id: ' + leagueId + ' ---');
            }
        },
        error: function(response) {
            console.log('--- Failed to load fixtures in league id: ' + leagueId + ' ---');
        }
    });
}
